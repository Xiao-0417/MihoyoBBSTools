...
bbs_login_url = f"{passport_api}/account/ma-cn-passport/app/loginByPassword"
bbs_login_web_url = f"{passport_api}/account/ma-cn-passport/web/loginByPassword"
...
bbs_login_verify_web = f"{bbs_api}/user/wapi/getUserFullInfo"
bbs_login_verify = "https://api-takumi.miyoushe.com/binding/api/getUserGameRolesByStoken"
